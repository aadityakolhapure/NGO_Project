...
<body class="h-screen flex flex-col">
    ...
    {{-- main section --}}
    <section class="bg-gray-50 dark:bg-gray-900 flex items-center justify-center flex-1">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1
                class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                Together, We Build Hope <span class="text-teal-500"></span></h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minima, unde.</p>
                @if (Route::has('login'))
                <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    @auth
                        @if (auth()->user()->role_id == 2)
                            <a href="{{ url('/NGO/dashboard') }}"
    ...
    <footer class="h-12 flex justify-center items-center">
        <p class="font-medium">Designed, Developed by
            <span class="underline text-teal-500">
                <a class="" target=”_blank” href="#">Frontend Alchemist</a>
            </span>
        </p>
    </footer>
